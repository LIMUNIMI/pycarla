...
# check if Carla is in this directory, if not, download it
if not os.path.exists('carla/Carla'):
    raise RuntimeError(
        "Carla has not been found in this directory. Please, download it from\
https://kx.studio/Applications:Carla and uncompress it in your working dir")
    sys.exit(1)
